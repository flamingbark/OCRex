...
_Source: Shopify, Stock Price examples_
    ...
    <div class="column">
      <div class="richtext richtext--center gap--large">
        ...
        <div class="content" data-content-limiter="true" data-pixel-perfect="true">
          <p>
            Article body text goes here. The content limiter will auto-adjust text size if it
            overflows.
          </p>
        </div>
      </div>
...
_Source: Days Left, GitHub examples_
...
_Source: GitHub Commits example_
...
_Source: Lunar Calendar example_
...
_Best for: Horoscopes, paired content, side-by-side comparisons_

```html
<div
  class="grid grid--cols-2 gap--xlarge"
  style="padding: 32px; height: 100%; font-family: Georgia, serif;"
>
  <div class="col layout layout--col layout--start gap--medium">
    <span style="font-size: 42px;">Heading</span>
    <span style="font-size: 24px;"
      >Body text here. Keep it readable with appropriate font sizing based on content length.</span
    >
  </div>
  <div class="col layout layout--col layout--start gap--medium">
    <span style="font-size: 42px;">Heading</span>
