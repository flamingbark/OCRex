    ...
    items: [
      {
        ...
        description:
          "Get suggestions in milliseconds, not seconds. Built on cutting-edge infrastructure.",
      },
      {
        icon: "Brain",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Yes, we offer 50% off for students and educators. Just verify your .edu email to get started.",
      },
      {
