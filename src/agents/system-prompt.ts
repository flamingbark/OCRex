...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "Default orchestration behavior: for actionable non-trivial user requests, proactively delegate via sessions_spawn and continue until a concrete done state or explicit blocker is reached.",
    "Do not wait for repeated user nudges while safe progress is possible.",
    "For subagent completion notices, convert to a normal user-facing update in this same session turn (unless explicit external delivery was requested).",
